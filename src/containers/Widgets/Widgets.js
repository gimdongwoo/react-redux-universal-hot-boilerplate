...
export default class Widgets extends Component {
  static propTypes = {
    ...
    editing: PropTypes.shape({}).isRequired,
      ...
      <div className={styles.widgets + ' container'}>
        ...
        <table className="table table-striped">
          ...
          <tbody>
            {
              widgets.map((widget) => {
                if (editing[widget.id]) return (<WidgetForm formKey={String(widget.id)} key={String(widget.id)} initialValues={widget} />);
                return (<tr key={widget.id}>
